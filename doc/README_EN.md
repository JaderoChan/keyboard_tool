...
- For the MSVC compiler, `pthread for Windows` needs to be configured, see also [pthreads-win32](https://sourceware.org/pthreads-win32/) (You can also use other available `pthread` libraries under Windows).
